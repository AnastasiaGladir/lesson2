package ru.mirea.gladirap.notificationapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickNewMassageNotification(View view) {
        ...
        NotificationChannel channel = new NotificationChannel(CHANNEL_ID, "Gladir Anastasia Pavlovna Notification", importance);
